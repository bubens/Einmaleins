module Thumbs exposing (down, left, right, rotatedBy, up)
...
{-
   Original Vectors by Perhelion:
       https://commons.wikimedia.org/wiki/File:Thumbs_up_icon.svg

   Published under Creative Commons Attribution-Share Alike 4.0 International
       https://creativecommons.org/licenses/by-sa/4.0/deed.en
-}


thumb : Direction -> Float -> Html msg
thumb direction w =
    let
        h =
            192 / 176 * w
        ...
        [ g
            ...
            [ defs
                ...
                [ radialGradient
                    ...
                    , cy "202"
                    , r "78"
                    , gradientTransform "matrix(.688 0 0 .309 69.1 134)"
            ...
            , g
                ...
                [ ellipse
                    ...
                    []
                , ellipse
                    [ transform "matrix(-.173 .985 -.989 -.151 0 0)"
                    , cx "93.7"
                    , cy "-45.7"
                    , rx "8.51"
                    , ry "13"
                    ...
                    []
                , ellipse
                    [ transform "matrix(-.269 .963 -.973 -.229 0 0)"
                    , cx "132"
                    , cy "-65.1"
                    , rx "6.71"
                    , ry "10.7"
                    ...
                    []
                , ellipse
                    [ transform "matrix(1 -.0122 .0329 .999 0 0)"
                    , cx "37.4"
                    , cy "179"
                    , rx "5.41"
                    , ry "4.72"
                    ...
                    []
                , Svg.path
                    [ d "m98.7 124c-0.151 4.05-5.74-1.2-7.07-2.52-4.1-4.07-7.02-7.69-9.41-13.1-3.36-7.68-6.06-14.8-6.55-23.2-0.134-2.32 2.81-3.53 4.38-1.51 2.81 3.59 4.14 5.55 7.25 12.4s11.8 16.6 11.4 28z"
                    , opacity ".8"
                    ]
                    []
                ]
...
right : Float -> Html msg
right width =
    thumb Right width


rotatedBy : Int -> Float -> Html msg
rotatedBy degrees width =
    thumb (RotatedBy degrees) width
